...
param("Densidade de materia 1_sigma_esquerda (L_1_sigma_Omega_M)", var1d[1][L_INDchi_sigma1])
param("Densidade de energia 1_sigma_esquerda (L_1_sigma_Omega_EE)", var1d[2][L_INDchi_sigma1])
param("Densidade de materia 1_sigma_direita (R_1_sigma_Omega_M)", var1d[1][R_INDchi_sigma1])
param("Densidade de energia 1_sigma_direita (R_1_sigma_Omega_EE)", var1d[2][R_INDchi_sigma1])
param("Qui-quadrado 2_sigma (chi2_2_sigma)", chi_sigma2)
param("Densidade de materia 2_sigma_esquerda (L_2_sigma_Omega_M)", var1d[1][L_INDchi_sigma2])
param("Densidade de energia 2_sigma_esquerda (L_2_sigma_Omega_EE)", var1d[2][L_INDchi_sigma2])
param("Densidade de materia 2_sigma_direita (R_2_sigma_Omega_M)", var1d[1][R_INDchi_sigma2])
param("Densidade de energia 2_sigma_direita (R_2_sigma_Omega_EE)", var1d[2][R_INDchi_sigma2])
param("Qui-quadrado 3_sigma (chi2_3_sigma)", chi_sigma3)
param("Densidade de materia 3_sigma_esquerda (L_3_sigma_Omega_M)", var1d[1][L_INDchi_sigma3])
param("Densidade de energia 3_sigma_esquerda (L_3_sigma_Omega_EE)", var1d[2][L_INDchi_sigma3])
param("Densidade de materia 3_sigma_direita (R_3_sigma_Omega_M)", var1d[1][R_INDchi_sigma3])
param("Densidade de energia 3_sigma_direita (R_3_sigma_Omega_EE)", var1d[2][R_INDchi_sigma3])
